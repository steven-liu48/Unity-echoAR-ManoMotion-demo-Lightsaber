...
public class ManoMotionSetup
{
    ...
    static ManoMotionSetup()
    {
        ...
        {
            PlayerSettings.applicationIdentifier = "com.manomotion.sdkliteexample";
            Debug.Log("Setting bundle id to com.manomotion.sdkliteexample from ManoMotionSetup script");
        }
